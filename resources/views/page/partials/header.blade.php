                    ...
                    <div class="col-md-12 p-0 d-flex align-items-center justify-content-end">
                        ...
                        <span class="d-flex align-items-center justify-content-end ml-2 pr-2">
                         <i class="fas fa-phone-volume mr-2 fa-lg multiled-color"></i>
                            <a href="mailto:{{ $contacto[0]['correo'] ?? '' }}" class="multiled-color font-weight-bold ">
                            Atención al cliente <br><h5><b class="font-weight-bold">4373-9500</b></h5>
                            </a>
                        </span>
                        ...
                        <a href="{{ url('jolden.buscador') }}" class="ml-2">
...
{{--                    @dd($cliente_elegido->type)--}}
            ...
            <div class="collapse navbar-collapse flex-md-column" id="navbarNav">
                <ul class="navbar-nav ml-auto d-flex align-items-center">
                    ...
                    {{--<li class="nav-item"><a class="nav-link ml-2 {{ request()->is('catalogos') ? 'activo' : '' }}" href="{{ url('jolden.productos') }}">CATÁLOGO</a></li>--}}
                    ...
                    @else
                        ...
                        <li class="nav-item"><a class="nav-link mx-2 font-weight-bold  {{ request()->is('contacto') ? 'activo' : '' }} " href="{{ url('jolden.contacto') }}">VIAL</a></li>
                        <li class="nav-item"><a class="nav-link mx-2 font-weight-bold  {{ request()->is('contacto') ? 'activo' : '' }} " href="{{ url('jolden.contacto') }}">SOLICITAR PRESUPUESTO</a></li>
                        <li class="nav-item"><a class="nav-link mx-2 font-weight-bold  {{ request()->is('contacto') ? 'activo' : '' }} " href="{{ url('jolden.contacto') }}">CONTACTO</a></li>
