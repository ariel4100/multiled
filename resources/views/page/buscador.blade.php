...
@section('content')
    <div class="container mt-5">
        ...
        <form class="row justify-content-center my-4" action="{{ route('jolden.buscador') }}" method="get">
            <div class="col-md-6">
                <input type="text" name="name" class="form-control my-2" placeholder="Buscar...">
            </div>
            <div class="col-md-6">
                <button type="submit" class="btn btn-md jolden-fondo text-white py-2 my-2" style="font-size: .80rem">Buscar</button>
            </div>
        </form>
                    ...
                    <a href="{{ route('jolden.productos',$item->slug) }}" class="">
                        <div class="">
                            ...
                            <div class=" d-flex justify-content-center align-items-center border" style="height: 100px;">
                                <div class="text-center">
                                    <h5 class="font-weight-bold jolden-color">
