...
<div class="container my-5">
    ...
    <nav class="d-block">
        <ol class="list-unstyled d-flex">
            ...
            <li class="pl-1">Pantallas Led</li>
            <li class="pl-1"> |</li>
            ...
            <ul class="list-unstyled">
                ...
                @forelse($senalizacion as $key=>$item)
                    ...
                    <li class="list-group-item border-0 px-0 py-0 bg-transparent pb-2">
                        <a href="{{ route('p.pantallas.show',$item->slug) }}" data-target="#familia_{{$key}}" data-toggle="collapse" aria-expanded="false" style="color: #595959;" class="d-flex align-items-center px-2 py-1 border-bottom {{ isset($producto) && $producto->id == $item->id ? 'multiled-color' : ''}}  ">
                            <span onclick="location.href='{{ route('p.pantallas.show',$item->slug) }}'">{!! $item->text['es']['title'] ?? $item->title !!}</span><i class="fas fa-chevron-right ml-auto"></i>
                        </a>
                    </li>
                @empty
